...
# Set BASE_PATH correctly (UI directory)
BASE_PATH = Path(__file__).parent

# Add BASE_PATH to Python path if needed
...
# Define page files
page_files = {
    "Welcome": os.path.join(BASE_PATH, "ui_pages", "welcome_page.py"),
    "Analyser": os.path.join(BASE_PATH, "ui_pages", "analyser.py"),
    "Contact": os.path.join(BASE_PATH, "ui_pages", "contact.py"),
    "About": os.path.join(BASE_PATH, "ui_pages", "About.py")
}

# Special case: jump to report
    ...
    if selected_page in page_files:
        ...
        try:
            if os.path.exists(page_path):
                ...
                st.warning(f"⚠️ Page file not found: {page_path}")
        except Exception as e:
